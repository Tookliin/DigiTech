    ...
    <div class="card" style="background-color: #181C30;">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between mt-2">
            ...
            <small class="text-white"><span><strong>480</strong></span>/<span></span>1000</small>
          </div>
          <div class="progress md-progress">
          ...
          <div class="d-flex justify-content-between mt-2">
            <small class="text-white">Self Employed</small>
            <small class="text-white"><span><strong>480</strong></span>/<span></span>1000</small>
          </div>
          <div class="progress md-progress">
          ...
          <div class="d-flex justify-content-between mt-2">
            ...
            <small class="text-white"><span><strong>250</strong></span>/<span></span>1000</small>
          </div>
          <div class="progress md-progress">
            <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100"
              aria-valuemin="0" aria-valuemax="100"></div>
