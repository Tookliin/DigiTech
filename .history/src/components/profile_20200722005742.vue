...
<section class=" customer-churn py-4">
    ...
    <h6 class="font-weight-bold text-center grey-text text-uppercase small mt-5">Admin</h6>
    <h3 class="font-weight-bold text-center dark-grey-text pb-2">
        Customer Churn</h3>
    <hr class="w-header my-4">
    <p class="lead text-center text-muted pt-2 mb-5">Please upload CSV or contact your Admin to intergrate your database for better and faster visualization
        
    </p>
    <p class="text-center text-muted">Teste</p>
