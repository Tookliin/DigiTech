...
<section class=" customer-churn py-4">
    ...
    <p class="lead text-center text-muted pt-2 mb-5">Please upload CSV or contact your Admin to intergrate your database for better and faster visualization</p>
<p>n</p>
