...
<div class="container ">
    <div class="row">
      <div class="col-lg-4 col-md-12 py-5 my-5">
        <div class="card mt-3">

          <div class="">
            <i class="far fa-money-bill-alt fa-lg primary-color z-depth-2 p-4 ml-3 mt-n3 rounded text-black"></i>
            <div class="float-right text-right p-3">
              <p class="text-uppercase text-muted mb-1"><small>Excited Clients</small></p>
              <h4 class="font-weight-bold mb-0">2017-2018</h4>
            </div>
          </div>
          ...
          <div class="card-body pt-0">
            ...
            <p class="card-text">Credit Solutions Peek(75%)</p>
          </div>
        </div>
      </div>

      <div class="col-lg-4 col-md-6 my-5 py-5">
        <div class="card mt-3">
          <div class="">
            <i class="fas fa-chart-line fa-lg teal z-depth-2 p-4 ml-3 mt-n3 rounded text-black"></i>
            <div class="float-right text-right p-3">
              <p class="text-uppercase text-muted mb-1"><small>Accounts Revoked</small></p>
              <h4 class="font-weight-bold mb-0">2018-2019</h4>
            </div>
          </div>
          <div class="card-body pt-0">
            <div class="progress md-progress">
              <div class="progress-bar bg-warning" role="progressbar" style="width: 60%" aria-valuenow="46" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>
            <p class="card-text">Drop In Credit (25%)</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 my-5 py-5">
        <div class="card mt-3">
          <div class="">
            <i class="fas fa-chart-pie fa-lg purple z-depth-2 p-4 ml-3 mt-n3 rounded text-black"></i>
            <div class="float-right text-right p-3">
              <p class="text-uppercase text-muted mb-1"><small>Client Churn</small></p>
              <h4 class="font-weight-bold mb-0">2019-2020</h4>
            </div>
          </div>
          <div class="card-body pt-0">
            <div class="progress md-progress">
              <div class="progress-bar bg-danger" role="progressbar" style="width: 31%" aria-valuenow="31" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>
            <p class="card-text">Clossing Accounts (31%)</p>
          </div>
        </div>
      </div>    
    </div>
 ...
 <!-- <section>
    ...
    <div class="client-card card card-list">
      <div class="card-header white d-flex justify-content-between align-items-center py-3" >
          
        <p class="h5-responsive font-weight-bold mb-0"><i class="fas fa-inbox pr-2"></i>Focust</p>
...
<!-- Customer Churn -->
<section class=" customer-churn py-4">
    ...
    <div class="row white-text">
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="sales card classic-admin-card primary-color">
          <div class="card-body py-3">
            <i class="far fa-money-bill-alt"></i>
            <p class="small">Home Loans</p>
            <h4>2017-2018</h4>
          </div>
          <div class="progress md-progress">
          ...
          <div class="card-body pt-2 pb-3">
            <p class="small mb-0">2020 Dropped From (75%)</p>
          </div>
        </div>
      </div>

      <div class="col-xl-3 col-md-6 mb-4">
        <div class="subscription card classic-admin-card warning-color">
          <div class="card-body py-3">
          ...
          <div class="card-body pt-2 pb-3">
            <p class="small mb-0">2020 Significant Drop (35%)</p>
          </div>
        </div>
      </div>
   ...
   <section>
    ...
    <div class="card" style="background-color: #181C30;">
      <div class="card-body">
<div class="text-center text-muted mb-5">
         <h5 class="text-center text-white font-weight-bold mb-4">Customer Churn</h5>
    </div>
        <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <div class="col-md-4 mb-0">
            <p class="text-grey mb-1"><i class="fas fa-caret-left mr-2"></i>70%</p>
            <p class="font-weight-bold mb-1">800</p>
            <p class="text-uppercase mb-0">satisfaction</p>
        </div>

          <div class="col-md-4 mb-4 mb-md-0">
            <p class="text-success mb-1"><i class="fas fa-caret-up mr-2"></i>63%</p>
            <p class="font-weight-bold mb-1">630</p>
            <p class="text-uppercase mb-md-0">Excited Customer</p>
          </div>

          <div class="col-md-4 mb-4 mb-md-0">
            <p class="text-danger mb-1"><i class="fas fa-caret-down mr-2"></i>27%</p>
            <p class="font-weight-bold mb-1">170</p>
            <p class="text-uppercase mb-md-0">Churn Customer</p>
          </div>
        </div>
      </div>
    </div>
...
export default {
    ...
    this.ctxB = document.getElementById("barChart").getContext('2d');
    this.myBarChart =  {
      type: 'bar',
      data: {
        labels: ["Red", "Blue", "Yellow", "Green", "Purple", "Orange"],
