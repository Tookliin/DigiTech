   ...
   <section>
    ...
    <div class="card" style="background-color: #181C30;">
      <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="d-flex justify-content-between">
            ...
            <small class="text-white"><span><strong>680</strong></span>/<span></span>1000</small>
          </div>

          <div class="progress md-progress">
            <div class="progress-bar bg-success" role="progressbar" style="width: 65%" aria-valuenow="35"
        ...
        <div class="d-flex justify-content-between mt-2">
          ...
          <div class="progress md-progress">
            <div class="progress-bar bg-info" role="progressbar" style="width: 80%" aria-valuenow="75"
              aria-valuemin="0" aria-valuemax="100"></div>
          </div>
      ...
      <div class="col-md-4 mb-4">
          ...
          <div class="d-flex justify-content-between">
            <small class="text-white">Add products to cart</small>
            <small class="text-white"><span><strong>160</strong></span>/<span></span>200</small>
          </div>
          <div class="progress md-progress">
            <div class="progress-bar bg-success" role="progressbar" style="width: 55%" aria-valuenow="55"
              aria-valuemin="0" aria-valuemax="100"></div>
          ...
          <div class="d-flex justify-content-between mt-2">
            <small class="text-white">Complete Purchase</small>
            <small class="text-white"><span><strong>310</strong></span>/<span></span>400</small>
          </div>
          ...
          <div class="d-flex justify-content-between mt-2">
            ...
            <small class="text-white"><span><strong>480</strong></span>/<span></span>800</small>
          </div>
          ...
          <div class="d-flex justify-content-between mt-2">
            ...
            <small class="text-white"><span><strong>250</strong></span>/<span></span>500</small>
          </div>
          <div class="progress md-progress">
            <div class="progress-bar bg-danger" role="progressbar" style="width: 100%" aria-valuenow="100"
              aria-valuemin="0" aria-valuemax="100"></div>
