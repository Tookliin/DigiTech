...
<section class="py-4">
    ...
    <h3 class="font-weight-bold text-center dark-grey-text pb-2">
        <i class="far fa-money-bill-alt fa-lg danger-color z-depth-2 p-4 ml-3 mt-n3 rounded text-white"></i><i class="far fa-money-bill-alt fa-lg primary-color z-depth-2 p-4 ml-3 mt-n3 rounded text-black"></i>Statistic Data</h3>
