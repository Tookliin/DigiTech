...
<div class="container ">
 ...
 <!-- <section>
    ...
    <div class="client-card card card-list">
      <div class="card-header white d-flex justify-content-between align-items-center py-3" v-for="month in months" :key="month">
        <p class="h5-responsive font-weight-bold mb-0"><i class="fas fa-inbox pr-2"></i>Sales</p>
        <p class="h5-responsive font-weight-bold mb-0"><a><i class="fas fa-times"></i></a> {{month}}</p>
      </div>
      <div class="card-body">
